    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Khorvi Associates",
          image: "",
          telephone: ["+91-9844135377", "+91-9591345320"],
          email: "khorviassociates@gmail.com",
          address: {
            "@type": "PostalAddress",
            streetAddress: "Plot No. B13/2, Behind Hotel Raghvendra, Khanapur Road, Udyambag",
